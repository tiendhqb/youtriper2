...
<html>
    <head>
        ...
        <title>YouTripper - Sales Login Page</title>

    </head>
    <body>
        <div ng-app="BeAdmin" ng-controller="BeAdminController" class="pagesearch">
                            ...
                            <form method="POST" 
                                  ...
                                  <c:choose>
                                      <c:when test="${empty param.language}">
                                          <c:url value="/Common/SalesmanLogin"/>
                                      </c:when>
                                      <c:otherwise>
                                          <c:url value="/Common/SalesmanLogin?language=${param.language}"/>
                                      </c:otherwise>
                                  </c:choose>" 
