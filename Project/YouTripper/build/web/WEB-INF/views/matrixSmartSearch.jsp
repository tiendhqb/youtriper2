...
<html>
    <head>
        ...
        <title>YouTripper - Matrix Smart Search</title>
    ...
    <body ng-app="YouTripper" ng-controller="MatrixSmartSearchController">
        <!-- Google Tag Manager -->
        ...
        <div class="pagesearch" id="routeDiv" style="background-color: #f2f2f4;">
            <%@ include file="header.jsp" %>
            <input type="hidden" name="" id="rowsPage" value="${requestScope.pageSize}" />
            <div class="container section-content padding-header searchPageContainer" ng-controller="FixedComparisonController" focus-search>
                <div class="">
                    <div class="search-content search-content">
                        <div id="recommend" class="full-page">
                            <div class="center-inform" ng-show="loadingFilter">
                                <div class="small-spinner"></div>
                            </div>
                            <div class="search-left full-page" ng-hide="loadingFilter" class="full-page">
                                <div class="fillter full-page">
                        ...
                        <div id="foundPackages" ng-controller="OptionsController" class="">
                            ...
                            <div class="search-right" ng-show="packagesLoaded">
                                ...
                                <div class="row" ng-hide="(packages.length <= 0 || sizeOfHashMap(suggestion) > 0) && packagesLoaded">
                                    <div class="package-box col-sm-4 col-xs-12"  ng-repeat="package in packages" init-boxer>
        ...
        <script>
                                                            ...
                                                            var subCate = '${requestScope.subCate}';
                                                            var locate = '${requestScope.locate}';
