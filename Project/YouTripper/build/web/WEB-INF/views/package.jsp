...
<!DOCTYPE html>
<html id="htmlID" ng-app="YouTripper" ng-controller="SpecificPackageController">
    <head>
                        ...
                        <div class="row">
                            ...
                            <div class="pkg-price-box">
                                <div class="pkg-price clearfix">
                                    <div class="book-now" ng-click="toggleDevelopingBox()">
                                        Book Now
                                    </div>
                                ...
                                <!--                                <div class="pgk-book-btn">
                                                                    <a href="javascript:callBooking()" class="bookButton btn btn-provider">Book Now</a>
                                                                    <a href="" class="btn-width-orange"  ng-click="toggleDevelopingBox()">Book Now</a>
                                                                </div>-->
                            </div>
                        ...
                        <div id="booking">
                            <div class="form-booking" data-wow-duration="1s">
                                <h3 class="form-header-title">
                                    <span class="btn-close-booking">
                                        <a href="javascript:callBooking()"><img src="<c:url value="/Images/Icon/close-booking.svg"/>" /></a>
                                    </span>
                                </h3>
                                <form action="<c:url value="/Tripper/Booking"/>" method="POST"
                                    ...
                                    <div class="form-group" style='position: relative'> 
                                        <input id="bookingBtn" ng-model="$parent.$parent.selectedDate" type="text" readonly="readonly" ng-click="toggleCalendar()"
                                               name="selectedDate" placeholder="Select date" class="text-input-custom normalFont blueInput booking-calendarInput" required/>
                                    ...
                                    <div class="form-group">
                                        <input  id="bookingTime"  type="text" class="text-input-custom normalFont blueInput booking-timeInput" min="0"
                                                ng-model="" name="bookingTime" placeholder="Time"/>
                                    </div>
                                    <div class="form-group">                                            
                                        <select name="selectedTime" class="text-input-custom normalFont blueInput booking-adultInput">
                                    ...
                                    <div class="form-group">                                            
                                        <select name="selectedTime" class="text-input-custom normalFont blueInput booking-childInput">
                                    ...
                                    <div class="booking-btn-row">
                                        <button type="submit" class="btn btn-custom-default btn-pink common-btn">Book</button>
                                    </div>

                                </form>
                                <div class="booking-btm">
                                    +5% service charge
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="optionsContainer">
                        <ul class='options-name clearfix'>
                            ...
                            <li>
                                <div class="pgk-book-btn">
                                    <!--<a href="javascript:callBooking()" class="bookButton btn btn-provider">Book Now</a>-->
                                    <a href="" class="bookButton btn btn-provider" ng-click="toggleDevelopingBox()">Book Now</a>
                                </div>
                            </li>
                        </ul>
