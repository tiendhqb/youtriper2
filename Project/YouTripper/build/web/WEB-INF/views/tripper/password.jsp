...
<html id="change-password">
    ...
    <body>
        <div class="pagesearch" ng-app="YouTripper" ng-controller="ChangeTripperPasswordController">
                    ...
                    <form method="POST" 
                          ...
                          <c:choose>
                              <c:when test="${empty param.language}">
                                  <c:url value="/Tripper/ChangePassword"/>
                              </c:when>
                              <c:otherwise>
                                  <c:url value="/Tripper/ChangePassword?language=${param.language}"/>
                              </c:otherwise>
                          </c:choose>" 
                          class="ytForm"
                        ...
                        <div class="form-input">
                            ...
                            <span ng-show="!change.currentPassword.length && showError.all">
                                <span ng-show="!change.currentPassword.length" style="color: red">Password can not blank!</span>                  
                            </span>
                        ...
                        <div class="form-input">
                            ...
                            <span ng-show="change.password.length < 8 && showError.all" style="color: red">New Password can not less than 10 characters</span>    
                        </div>
                        <!--<p>Retype password</p>-->
                        <div class="form-input">
