    ...
    <body>
        ...
        <div class="pagesearch selected-messages" id="chatPage" ng-cloak ng-hide="loading">
                                                ...
                                                <div id="Messages">
                                                    <div class="message-left">
                                                        <div class="search-message packageCtr">
                                                            <div id="package-chat-container" class="packagesDdl">
                                                                <div id="dpackageDdlSelect" class="PackageColorSelect" ng-click="selectPackageForView()">
                                                                    <span class="selected" ng-style="">All Packages</span>
                                                                </div>                                    
                                                                <div  class="packgeDropdownMenu">
                                                                    <ul>
                                                                        <li>
                                                                        ...
                                                                        <li ng-repeat="package in packageList">
                                                                            <a href="" ng-click="changeSelectedPackage(package.id)">
                                                                                {{package.name}}
                                                                            </a>
                                                                        </li>                                                                        
                                                                    </ul>
                                                            ...
                                                            <div id="search-message" ng-click="sendmessage()">
            ...
            <div class="image-boxer">
                ...
                <img src="http://localhost:8084/Images/17/17-1.jpg" title=""/>
            </div>
