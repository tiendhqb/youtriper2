...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<c:url value="/Resources/Theme/css/youtripper.css?99999999999999999999999999999999"/>" >
        ...
        <title>Tripper Page</title>
    </head>
    <body ng-app="YouTripper" ng-controller="TripperPageController">
        <!-- Google Tag Manager -->
        ...
        <div class="pagesearch active-bg">
            ...
            <section class="padding-header cols-provider" ng-controller="FixedComparisonController">
                <div class="container">
                        ...
                        <div class="col-lg-3 col-md-3">
                            ...
                            <div class="provider-left">
                                <div style="margin-bottom: 20px; margin-top: 20px; text-align: center" class="upload-avatar">
                                    <img alt="" ng-src="/{{TripperInfo.image}}" />
                                </div>
                        ...
                        <div class="col-lg-9 col-md-9">
                            ...
                            <div class="provider-right">
                                <div class="intro-provider">
                                    <h1>{{TripperInfo.lastName}}</h1>
                                    <p>{{TripperInfo.city}} {{TripperInfo.countryName}} Member since {{TripperInfo.activeDate}} </p>
<!--                                    <p>Languages: {{TripperInfo.Language}}</p>-->
                                    <p class="report">
                                        <c:if test="${sessionScope.account != null}">
                                            <c:if test="${sessionScope.account.role == 1}">
                                                <a class="href-silver" ng-show="reportYourOwn(${sessionScope.account.id})" data-toggle="modal" data-target="#myModal"><span></span>Report this Tripper</a>
                                                    </c:if>
                                                    <c:if test="${sessionScope.account.role == 2}">
                                                <a class="href-silver" data-toggle="modal" data-target="#myModal"><span></span>Report this Tripper</a>
                                                    </c:if>
                                                </c:if>
                                    </p>
                                    <p>
                                        {{TripperInfo.information}}
                                    </p>
                                </div>
                                <div class="point-review">
                                    <!--                                    <span><strong>{{TripperInfo.reviewList[0].totalRecords}}</strong>Reviews</span>-->
                                    <span><strong>0</strong>Reviews</span>
                                    <!--<span><strong>{{totalRating}}</strong>Rating</span>-->
                                    <div class="clearfix"></div>
                                </div>

                                <div class="title-reviews">
                                    <h3 class="posts-reviews">Bucket List ({{TripperInfo.bucketList.length}})</h3>
                                </div>

                                <div style="text-align: center; margin-bottom: 20px; margin-top: 20px" ng-show="{{TripperInfo.bucketList.length}} <= 0">
                                    No packages.
                                </div>
                                <div id ="next-slide" class=" slider-provider-outer" ng-controller="OptionsController">
                                    <div ng-show="{{TripperInfo.bucketList.length}} > 2">
                                        <a id="goToPrevSlide" class="preButton"></a>
                                        <a id="goToNextSlide" class="nextButton"></a>
                                    </div>

                                    <ul id="packageSlide" class="slide-provider" >
                                        <li id ="next-slide" ng-repeat="package in TripperInfo.bucketList" class="slider" init-boxer>
                                ...
                                <div class="title-reviews">
                                    <h3 class="posts-reviews">Booking List ({{TripperInfo.bookingList.length}})</h3>
                                </div>

                                <div style="text-align: center; margin-bottom: 20px; margin-top: 20px" ng-show="{{TripperInfo.bookingList.length}} <= 0">
                                    No packages.
                                </div>

                                <div id ="next-slide-booking" class=" slider-provider-outer" ng-controller="OptionsController">
                                    <div ng-show="{{TripperInfo.bookingList.length}} > 2">
                                        <a id="goToPrevSlideBooking" class="preButton"></a>
                                        <a id="goToNextSlideBooking" class="nextButton"></a>
                                    </div>

                                    <ul id="packageSlideBooking" class="slide-provider" >
                                        <li id ="next-slide-booking" ng-repeat="package in TripperInfo.bookingList" class="slider" init-boxer>
                                ...
                                <section id="reviews">
                                    <div class="row content-normal">
                                        <div class="col-md-12">
                                            <div class="title-reviews">
                                                <h3 class="posts-reviews">{{TripperInfo.reviewList[0].totalRecords}} Reviews</h3>
                                            </div>
                                            <div class="posts-comment">
                                                <div ng-repeat="review in TripperInfo.reviewList" class="posts-user-comment clearfix">
            ...
            <div class="modal fade" id="myModal" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="report-box">
                        <form method="POST" action="<c:url value="/Common/ReportTripper"/>" ng-submit="validateReportForm($event)">
                            <div class="report-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 class="modal-title">Do you want anonymously report this tripper?</h4>
                            </div>
                            <div class="modal-body">
                                ...
                                <input style="display: none" type="text" ng-value="{{TripperInfo.tripperID}}" name="tripperID">
                                ...
                                <div ng-show="error" style="color: red">Please select 1 option </div>
            ...
            <script>
                                    var tripperInfo = ${requestScope.TripperInfo};
                                    var reportType = ${requestScope.ReportType};
                                    var getReviewUrl = '<c:url value="/Common/getReviewOfTripper"/>';
                                    ...
                                    var slider2 = $('#packageSlideBooking').lightSlider({
                                    item: 2,
                                            loop: false,
                                            slideMove: 1,
                                            easing: 'cubic-bezier(0.25, 0, 0.25, 1)',
                                    ...
                                    $('#goToPrevSlideBooking').click(function () {

                                    slider2.goToPrevSlide();
                                    });
                                    $('#goToNextSlideBooking').click(function () {
