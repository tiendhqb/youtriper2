                    ...
                    <div class="step-container">
                        <form  name="activityForm" novalidate>
                            ...
                            <div class="row row-select subCateRow">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12 sub-col">
                                    <select>
...
<!--                                            <div>
                                            ...
                                            <div class="col-xs-4 popup-option" ng-repeat="subCategory in formContent.subCategories| filter: {categoryID : secondCategory.id}">
                            ...
                            <div class="row row-select actRow">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12 act-col">
                                    ...
                                    <div class="popupBox">
                                        <div class="row category-row" ng-repeat="secondSubCategory in selectedSubCategories">
                                            ...
                                            <div class="col-xs-4 popup-option" ng-repeat="activity in formContent.activities| filter: {subCategoryID : secondSubCategory.subCategoryID}">
                                                <div class="tempCheckbox">
                            ...
                            <div class="row row-select">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <ul>
                                        <li class="col-xs-3" ng-repeat="groupType in formContent.groupTypes">
                                            <div class="tempCheckbox">
                            ...
                            <div class="row row-select">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <ul>
                                        <li class="col-xs-3" ng-repeat="tripType in formContent.tripTypes">
                                            <div class="tempCheckbox">
                        ...
                        <form name="descriptionForm" novalidate>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-5 col-xs-12">
                                    ...
                                    <input class="normalFont round"
                                           ng-model="package.departureTime" type="time" placeholder="HH:mm:ss" name="departureTime"/>
                                </div>
                                <div class="col-md-1 col-sm-1 col-xs-12 text-center">
                                ...
                                <div class="col-md-3 col-sm-5 col-xs-12">
                                    ...
                                    <input type="text" class="round normalFont"
                                           ng-model="package.departureLocation" type="text" placeholder="Deoarture Location" name="departureLocation" maxlength="100" required/>
                                </div>
                            </div>
                            <h3>Languages</h3>
                            <div class="row">
                ...
                <div id="Location">
                    <div class="step-container">
                        ...
                        <form name="locationForm" novalidate>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <input id="pac-input" class="controls normalFont" type="text" value="{{package.city + ' ' + package.state + ' ' + package.country}}"
                        ...
                        <form  name="priceForm" novalidate>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <h5>{{(package.ordinaryPriceForAdult * package.youtripperPercentage) / 100 | currency}}</h5>
                                </div>
                                <div class="col-md-6">
                                    <span ng-show="package.ordinaryPriceForChild > 0">
                                        <h2 style="margin-top:50px">Youtripper Price (USD/PAX) - Child</h2>
                                        <h5>{{(package.ordinaryPriceForChild * package.youtripperPercentage) / 100 | currency}}</h5>
                                    </span>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <form name="calendarForm" novalidate>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input class="round" ng-model="package.startDate" type="text" id="from" name="from" required>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input class="round" ng-model="package.endDate" type="text" id="to" name="to" required>
                                </div>
                            </div>
                            ...
                            <div id="promotion-form" style="display: none;">
                                <div class="promotion-content">
                                    <div class="promotion-elements">
                                        ...
                                        <div class="row control-bar right-control">
