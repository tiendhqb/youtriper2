...
function SmartWizard(target, options) {
    ...
    this.contentWidth = 0;
    this.elmStepContainer = $('<div></div>').addClass("container container-package");
    this.elmStepContainer.wrap("<div class='content'></div>")
...
//        $this.target.children('ul').addClass("anchor");
        $this.target.children('ul').wrap("<div class='bar-wizard content'><div class='container container-package'></div></div>");
