...
(function($) {
  ...
  $.paletteColorPicker = function( el, options ) {
    ...
    plugin.init = function() {
        ...
        var
          ...
          $sw = $('<span>').addClass('swatch')
            .attr({
              ...
              'data-color': col,
              'data-name': key
            }).css('background-color', col).attr('ng-click','selectColorFormPalette()');
      ...
      // Create clear button
      var
        $clear_btn = $('<span>').addClass('swatch clear').attr('title', 'Clear selection').attr('ng-click','selectColorFormPalette()');
